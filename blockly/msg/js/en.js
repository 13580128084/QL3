...
Blockly.MIXLY_DUANKOU = 'Port';
Blockly.MIXLY_CHUPENG = 'Touch';
Blockly.MIXLY_HONGWAIXUNJICANKAO = 'Infrared tracking simulation reference value';
Blockly.MIXLY_HONGWAIXUNJI = 'Infrared tracking mode';
Blockly.MIXLY_LEIXING = 'Type';
Blockly.MIXLY_CHAOSHENGBO = 'Ultrasonic ranging';
Blockly.MIXLY_MONISHUZHI = 'value of simulation';Blockly.MIXLY_SHUZHI = 'numerical value';Blockly.MIXLY_MONIZHUANSHUZHI = 'staircase ADC';
Blockly.MIXLY_YANSEYUJULI = 'Color and Distance';
Blockly.MIXLY_TS_YANSEYUJULI = 'RGB value and distance value of sensor can be obtained, gesture and color function conflict, not provided for the moment.';
Blockly.MIXLY_HUANJINGGUANG = 'Ambient Brightness';
Blockly.MIXLY_JIEJIN = 'draw near';