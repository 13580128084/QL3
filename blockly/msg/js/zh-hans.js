...
Blockly.MIXLY_DUANKOU = '端口';
Blockly.MIXLY_CHUPENG = '触碰';
Blockly.MIXLY_HONGWAIXUNJICANKAO = '红外循迹模拟参考值';
Blockly.MIXLY_HONGWAIXUNJI = '红外循迹';
Blockly.MIXLY_LEIXING = '类型';
Blockly.MIXLY_CHAOSHENGBO = '超声波测距';
Blockly.MIXLY_MONISHUZHI = '模拟值';Blockly.MIXLY_SHUZHI = '数字值';Blockly.MIXLY_MONIZHUANSHUZHI = '模拟转数值';
Blockly.MIXLY_YANSEYUJULI = '颜色与距离';
Blockly.MIXLY_TS_YANSEYUJULI = '可以获取到传感器RGB值和距离值，手势与颜色功能冲突，暂时未提供。';
Blockly.MIXLY_HUANJINGGUANG = '环境光强度';
Blockly.MIXLY_JIEJIN = '接近';