...
Blockly.Arduino.QLmotor = function() {
  ...
  switch(motorNO){
   ...
   Blockly.Arduino.definitions_['include_Motion'] =  '#include <Motion.h> ';
   Blockly.Arduino.setups_['setup_Motion_begin'+io] = 'Motion_begin(' + io + ',' + pwm + ');';
   if(speed<0){
    fx=0;
  }
   return 'Motion_one(' + io + ','+ pwm + ','+ fx + ',' + Math.abs(speed) + ');\n';
 };



 Blockly.Arduino.QLmotor1 = function() {
  var motorNO = this.getFieldValue('motor1');
  var io='0';
  var adc='0';
  var pwm='0';
  ...
  var m1_1=io;
  var m1_2=pwm;
  var motorNO = this.getFieldValue('motor2');
  switch(motorNO){
    case '1':io='8';adc='A3';pwm='9';break;
    case '2':io='12';adc='A6';pwm='10';break;
    case '3':io='13';adc='A7';pwm='11';break;
  ...
  var speed1 = Blockly.Arduino.valueToCode(this, 'SPEED1', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';  
  var speed2 = Blockly.Arduino.valueToCode(this, 'SPEED2', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';  


   Blockly.Arduino.definitions_['include_Motion'] =  '#include <Motion.h> ';
   Blockly.Arduino.setups_['setup_Motion_begin'+m1_1] = 'Motion_begin('+m1_1+','+m1_2+');\n';
    Blockly.Arduino.setups_['setup_Motion_begin'+m2_1] = 'Motion_begin('+m2_1+','+m2_2+');\n';
   var fx1;
   var fx2;
   if(speed1<0){fx1=0;}else{fx1=1;}
   if(speed2<0){fx2=0;}else{fx2=1;}
   var code = 'Motion_two(' + m1_1 + ','+ m1_2 + ','+ fx1 + ',' + Math.abs(speed1) +','+ m2_1 + ','+ m2_2 + ','+ fx2 + ',' + Math.abs(speed2)+ ');\n';
   return code;
 };
